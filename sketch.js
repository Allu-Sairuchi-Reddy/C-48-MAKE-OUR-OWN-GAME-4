...
function setup() {
  ...
  form.display();
    ...
    ground1 = new Ground(600, 550, 1800, 20);

    plf= new Ground(200, 300, 200, 20);
    plf2= new Ground(500, 300, 200, 20);
    plf3 = new Ground(800, 300, 200, 20);
    plf4 = new Ground(1100, 300, 200, 20);

    shp1=Bodies.circle(500,500,50,{restitution:0.5});
    World.add(world,shp1);
    shp2=Bodies.circle(200,500,50,{restitution:0.5});
    World.add(world,shp2);
    shp3=Bodies.circle(700,500,50,{restitution:0.5});
    World.add(world,shp3);
    shp4=Bodies.circle(900,500,50,{restitution:0.5});
    World.add(world,shp4);
...
if(gameState===9){
  ...
  image(im1,shp1.position.x,shp1.position.y,50,50);
  image(im2,shp2.position.x,shp2.position.y,50,50);
  image(im3,shp3.position.x,shp3.position.y,50,50);
  image(im4,shp4.position.x,shp4.position.y,50,50);
